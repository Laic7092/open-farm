...
## 岸沿挡光打进水面里的暗带：比 [constant WATER_DARK] 再深一档。
const WATER_SHADOW := Color8(30, 70, 122)
...
# 矿石：基底是石头色，矿脉用各自的金属色。
const COPPER := Color8(196, 118, 70)
const COPPER_DARK := Color8(148, 84, 48)
const COPPER_LIGHT := Color8(226, 158, 110)
const IRON := Color8(176, 178, 184)
const IRON_DARK := Color8(126, 128, 136)
const IRON_LIGHT := Color8(214, 216, 222)
const GOLD := Color8(232, 190, 76)
const GOLD_DARK := Color8(178, 138, 44)
const GOLD_LIGHT := Color8(250, 226, 138)
