...
加内容见 [AGENTS.md](AGENTS.md)「任务路由」：内容都在 `data/**/*.tres`，脚本只认 id，改完重跑 `build_assets.sh`。
...
新系统必须延续 [AGENTS.md](AGENTS.md) 的架构约定。

## 文档地图

只有两份，架构与约定细节以 `AGENTS.md` 为准，本文件不复述：

| 文档 | 内容 |
| --- | --- |
| `README.md`（本文件） | 面向人：怎么跑、怎么玩、操作、扩展入口、下一步 |
| [AGENTS.md](AGENTS.md) | 面向贡献者与 Agent：约束、任务路由、Godot 坑、测试与大文件协议 |
